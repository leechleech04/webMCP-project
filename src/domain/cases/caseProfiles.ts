...
const SFF_TRANSFORMS: Record<string, SceneTransform> = {
  ...
  "storage-m2-1": { position: [-0.75, 3.55, 0], rotation: [0, Math.PI / 2, 0] },
...
const LFF_TRANSFORMS: Record<string, SceneTransform> = {
  ...
  "storage-m2-1": { position: [-1.05, 5.15, 0.5], rotation: [0, Math.PI / 2, 0] },
...
export const caseProfiles: CaseProfile[] = [
  {
    ...
    supportedMountIds: ["case-root", "motherboard-tray", "cpu-socket-1", "dimm-a1", "dimm-b1", "storage-m2-1", "pcie-slot-1", "radiator-top", "radiator-front", "psu-bay", ...MINI_FAN_IDS],
  ...
  },
  {
    ...
    supportedMountIds: ["case-root", "motherboard-tray", "cpu-socket-1", "dimm-a1", "dimm-b1", "storage-m2-1", "pcie-slot-1", "radiator-top", "radiator-front", "psu-bay", ...SFF_FAN_IDS],
  ...
  },
  {
    ...
    supportedMountIds: ["case-root", "motherboard-tray", "cpu-socket-1", "dimm-a1", "dimm-b1", "storage-m2-1", "pcie-slot-1", "radiator-front", "radiator-top", "psu-bay", ...MFF_FAN_IDS],
  ...
  },
  {
    ...
    supportedMountIds: ["case-root", "motherboard-tray", "cpu-socket-1", "dimm-a1", "dimm-b1", "storage-m2-1", "pcie-slot-1", "radiator-front", "radiator-top", "psu-bay", ...LFF_FAN_IDS],
